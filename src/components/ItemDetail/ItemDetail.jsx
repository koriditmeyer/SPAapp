    ...
    return (
      <article className="bg-white bg-opacity-90 rounded-lg shadow-md p-4 flex-grow ">
          <a className="flex justify-center ">
            <img className="h-[200px]  mix-blend-multiply " src={properties.image}></img>
          </a>
          <p className="text-xl font-semibold mb-2 text-center">Title: {properties.title}</p>
          <p className="text-xl font-semibold mb-2 text-red-600">Price: {properties.price}$</p>
